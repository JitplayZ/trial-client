-- Fix: Modify process_referral to use auth.uid() instead of accepting user_id parameter
-- This prevents attackers from calling the RPC with manipulated user IDs
